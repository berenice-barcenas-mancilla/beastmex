...
<div class="modal fade" id="userNewModal" tabindex="-1" role="dialog" aria-labelledby="userNewModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" id="newFormProduct" action="{{ route('store.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <input type="text" class="form-control" id="name" name="txtName"
                                placeholder="Ingresa el nombre" value="{{ old('txtName') }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <input type="text" class="form-control" id="serial_number" name="txtSerialNumber"
                                placeholder="Ingresa el número de serie" value="{{ old('txtSerialNumber') }}">
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <select class="form-control" name="brand" id="brand">
                                ...
                                <option value="Gigabyte" {{ old('brand') == 'Gigabyte' ? 'selected' : '' }}>Gigabyte
                                </option>
                                <option value="AMD" {{ old('brand') == 'AMD' ? 'selected' : '' }}>AMD</option>
                                <option value="Intel" {{ old('brand') == 'Intel' ? 'selected' : '' }}>Intel</option>
                                <option value="Corsair" {{ old('brand') == 'Corsair' ? 'selected' : '' }}>Corsair
                                </option>
                                <option value="HyperX" {{ old('brand') == 'HyperX' ? 'selected' : '' }}>HyperX</option>
                                <option value="Kingston" {{ old('brand') == 'Kingston' ? 'selected' : '' }}>Kingston
                                </option>
                                <option value="Logitech" {{ old('brand') == 'Logitech' ? 'selected' : '' }}>Logitech
                                </option>
                                <option value="Razer" {{ old('brand') == 'Razer' ? 'selected' : '' }}>Razer</option>
                                <option value="Thermaltake" {{ old('brand') == 'Thermaltake' ? 'selected' : '' }}>
                                    Thermaltake</option>
                                <option value="Cooler Master" {{ old('brand') == 'Cooler Master' ? 'selected' : '' }}>
                                ...
                                <option value="Seasonic" {{ old('brand') == 'Seasonic' ? 'selected' : '' }}>Seasonic
                                </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <input type="text" class="form-control" id="stock" name="txtStock"
                                placeholder="Ingresa el stock" value="{{ old('txtStock') }}">
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <input type="text" class="form-control" id="purchase_cost" name="txtPurchaseCost"
                                placeholder="Ingresa el costo de compra" value="{{ old('txtPurchaseCost') }}">
                        </div>
                        <div class="col-md-5">
