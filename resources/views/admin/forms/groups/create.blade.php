<!--begin::EditModal-->
<div class="modal fade" id="groupNewModal" tabindex="-1" role="dialog" aria-labelledby="groupNewModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="post" id="newFormGroup" action="/groups">
                {{ csrf_field() }}
                <div class="modal-body">
