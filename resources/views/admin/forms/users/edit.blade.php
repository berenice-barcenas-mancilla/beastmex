<!--begin::EditModal-->
<div class="modal fade" id="userEditModal" tabindex="-1" role="dialog" aria-labelledby="priceEditModal" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-custom alert-default" role="alert">
                    ...
                    <div class="alert-text">
                        ...
                        No es necesario que ingreses una contraseña a menos que desees actualizarla
                    </div>
                </div>
            </div>
               
                                                
            <form class="form" method="post" id="editFormUser" action="#">
                {{ csrf_field() }}
                @method('PATCH')
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <input type="text" class="form-control" id="lastNameEdit" required name="last_name" placeholder="Ingresa el apellido"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <input type="email" class="form-control" id="emailEdit" required name="email" placeholder="Ingresa el correo"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <select class="form-control" name="group" id="groupEdit" required>
