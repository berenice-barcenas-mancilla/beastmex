<!--begin::Modal-->
<div class="modal fade" id="employeeRecordModal" tabindex="-1" role="dialog" aria-labelledby="employeeRecordModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="post" id="recordReport" action="/reports/shop" target="_blank">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <input hidden type="text" class="form-control" id="type" required name="type" value="ACTAS"/>
                        </div>
                    </div>
                </div> 
...
<!--begin::Modal Grafica-->
<div class="modal fade" id="graficacompras" tabindex="-1" role="dialog" aria-labelledby="employeeReportSuspendedModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Gráfica de Compras</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="la la-remove"></span>
                </button>
            </div>
            ...
            <form class="form" method="post" id="recordReport" action="/reports/shopgraph" target="_blank">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-3 col-sm-12"> <b>Fecha de inicio  *</b> </label>
