...
<!--begin::Modal Grafica-->
<div class="modal fade" id="graficalmacen" tabindex="-1" role="dialog" aria-labelledby="employeeReportSuspendedModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Gráfica de almacen</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="la la-remove"></span>
                </button>
            </div>
            ...
            <form class="form" method="post" id="recordReport" action="/reports/storegraph" target="_blank">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-3 col-sm-12"> <b>Fecha de inicio  *</b> </label>
