                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                      <td style='width:250px;'>
                                                                        <img alt='Descriptive Alt Text' height='auto' src='{{ asset('images/beastmex.png') }}' />
                                                                    </td>
...
<![endif]-->
        <table align='center'
            background='https://assets.opensourceemails.com/imgs/lifestyle/binu6fnar8unlra4bqse_osetu-product-header.jpg'
            border='0' cellpadding='0' cellspacing='0' role='presentation'
            style='background:#f0f0f0 url(https://assets.opensourceemails.com/imgs/lifestyle/binu6fnar8unlra4bqse_osetu-product-header.jpg) top center / cover no-repeat;width:100%;'>
            <tbody>
                <tr>
                    <td>
                        <!--[if mso | IE]>
                                                                    ...
                                                                    <table border='0' cellpadding='0'
                                                                        ...
                                                                        <tr>
                                                                            <td align='left'
                                                                                ...
                                                                                <div
                                                                                    style='color:#000000;font-family:Martel;font-size:22px;font-weight:900;line-height:72px;text-align:left;'>
                                                                                    Orden de Compra
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align='left'
                                                                                style='font-size:0px;padding:10px 25px;padding-bottom:50px;padding-top:00px;word-break:break-word;'>
                                                                                <div
                                                                                    style='color:#000000;font-family:Martel;font-size:56px;font-weight:900;line-height:72px;text-align:left;'>
                                                                                    BEASTMEX
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                                ...
                                                                                <table border='0' cellpadding='0'
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align='center'
                                                                                            bgcolor='BLACK'
                                                                                            role='presentation'
                                                                                            style='background-color:BLACK;border:none;border-radius:0px;cursor:auto;padding:10px 25px;'
                                                                                            valign='middle'>
                                                                                            <a href='#'
                                                                                                style='background:BLACK;color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:22px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;'
                                                                                                target='_blank'>
                                                                                                Click Here
                                                                                            </a>
                                                                                        </td>
        ...
        <div style='margin:0px auto;max-width:600px;'>
            <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation'
                ...
                <tbody>
                    <tr>
                        <td
                            style='direction:ltr;font-size:0px;padding:10px 20px;text-align:center;vertical-align:top;'>
                            <!--[if mso | IE]>
<table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:600px;">
<![endif]-->
                            <div class='dys-column-per-100 outlook-group-fix'
                                ...
                                <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                                    ...
                                    <tr>
                                        <td align='left'
                                            style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                            <div
                                                style='color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:24px;font-weight:Bolder;line-height:32px;text-align:left;'>
                                                Detalle de la Orden de Compra de Beastmex
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td align='left'
                                            ...
                                            <div
                                                ...
                                                Estimado/a ,
                                                <br>
                                                Espero que este mensaje le encuentre bien. Mi nombre es Berenice Barcenas Mancilla y soy 
                                                auxiliar de compras en BEASTMEX. Nos dirigimos a usted para solicitar la compra de:
                                                <br>
                                                Descripción del Producto:
                                                <br>
                                                Cantidad:
                                                <br>
                                                Agradecemos de antemano su pronta atención a esta solicitud. Estamos seguros de que esta adquisición fortalecerá nuestras operaciones y contribuirá al éxito general de BEASTMEX
                                                <br>
                                                Información de Contacto: compras@beastmex.com
                                            </div>
                                        </td>
                                    </tr>
                                </table>
...
<![endif]-->
        <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation'
            style='background:black;background-color:black;width:100%;'>
            <tbody>
                <tr>
                    <td>
                        <div style='margin:0px auto;max-width:600px;'>
                                                        ...
                                                        <td align='left'
                                                            ...
                                                            <table border='0' cellpadding='0' cellspacing='0'
                                                                ...
                                                                <tr>
                                                                    <td align='left'>
                                                                        <div
                                                                            style='color:#666666;font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:28px;text-align:left;'>
                                                                            <p>
                                                                                © Copyright BEASTMEX 2023
                                                                                <br />
                                                                                <a href='#'
                                                                                    style='color: #666;'>
                                                                                    Privacy Policy
