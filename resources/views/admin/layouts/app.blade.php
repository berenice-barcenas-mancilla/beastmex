                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 314px; overflow: hidden;">
                            ...
                            <ul class="menu-nav ">
                                ...
                                <li class="menu-item @if($PAGE_NAVIGATION == 'USERS') menu-item-active @endif" aria-haspopup="true" >
                                ...
                                <li class="menu-item @if($PAGE_NAVIGATION == 'GROUPS') menu-item-active @endif" aria-haspopup="true" >
                                ...
                                {{-- Con "can" se fitra si el usuario logeado segun su rol tiene o no permiso de acceder a ese modulo 
                                Si se tiene permiso se muestra la opción--}}
                                <li class="menu-item @if($PAGE_NAVIGATION == 'REPORTS') menu-item-active @endif" aria-haspopup="true" >
                ...
                <div class="d-flex align-items-center mt-5">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="navi mt-2">
                            ...
                            <p>&nbsp;</p>
                            <a class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form2').submit();">
