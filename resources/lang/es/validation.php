...
return [
    ...
    */
    ...
    'letter'               => 'El campo :attribute debe contener al menos una letra',
    ...
    */
    ...
    'attributes' => [
        'code'                                      => 'Código',
        'no_cliente'                                => 'No de cliente',
        'nombre_del_cliente'                        => 'Nombre de cliente',
        'total_de_equipos'                          => 'Total de equipos',
        'costo_total'                               => 'Precio unitario',
        'aplica_anticipo'                           => 'Aplica anticipo',
        'condicion_de_venta'                        => 'Condición de venta',
        'fecha_de_entrega_de_instalacion'           => 'Fecha entrega de instalación',
        'observation'                               => 'Observación',
        'probability'                               => 'Probabilidad',
        'unexpected'                                => 'Tipo de pago',
        'type'                                      => 'Tipo',
        'date_payment'                              => 'Fecha de pago',
        'invoice'                                   => 'No. de factura',
        'date_invoice'                              => 'Fecha de facturación',
        'technicals'                                => 'Cuadrilla'
    ],
