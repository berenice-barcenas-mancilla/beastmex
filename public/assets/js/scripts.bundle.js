				...
				pagination: {
					items: {
						default: {
							...
							select: 'Seleccionar el tamaño de página',
							all: 'Todos',
						},
...
function suspendedActivedItem(url, title, message, subtitle) 
{
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                error: function () {
                    toastr.error("Ocurrio un error al realizar la acción, si persiste el problema contacte a su administrador");
                }
            });
            
        } else if (result.dismiss === "cancel") {

            toastr.warning("La acción ha sido cancelada");
        }
    });
}
